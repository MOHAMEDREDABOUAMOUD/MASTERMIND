...
Public Class level_1
    ...
    End Sub
    ''''''''''''''''''''''''''''''''''''''
    Private Sub bclick(round As Integer, but2 As Button, grp1 As GroupBox, grp2 As GroupBox, pinn1 As PIN, pinn2 As PIN, pinn3 As PIN, pinn4 As PIN, pinn_res1 As PIN, pinn_res2 As PIN, pinn_res3 As PIN, pinn_res4 As PIN, pinn_1 As PIN, pinn_2 As PIN, pinn_3 As PIN, pinn_4 As PIN)
        ...
        If pinn_1.BackColor = Color.Blue And pinn_2.BackColor = Color.Blue And pinn_3.BackColor = Color.Blue And pinn_4.BackColor = Color.Blue Then
            ...
            f_win.Label2.Text = "  Time : " & min & ":" & sec & ":" & mlsec
            f_win.Label3.Text = "  Rounds : " & rounds
            f_win.ShowDialog()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (Pin1.BackColor <> Color.Black And Pin2.BackColor <> Color.Black And Pin3.BackColor <> Color.Black And Pin4.BackColor <> Color.Black) Then
            bclick(rounds, Button1, GroupBox1, GroupBox2, Pin1, Pin2, Pin3, Pin4, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_1, Pin_2, Pin_3, Pin_4)
        Else
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        ElseIf (Pin5.BackColor <> Color.Black And Pin6.BackColor <> Color.Black And Pin7.BackColor <> Color.Black And Pin8.BackColor <> Color.Black) Then
            bclick(rounds, Button2, GroupBox2, GroupBox3, Pin5, Pin6, Pin7, Pin8, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_5, Pin_6, Pin_7, Pin_8)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf (Pin9.BackColor <> Color.Black And Pin10.BackColor <> Color.Black And Pin11.BackColor <> Color.Black And Pin12.BackColor <> Color.Black) Then
            bclick(rounds, Button3, GroupBox3, GroupBox4, Pin9, Pin10, Pin11, Pin12, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_9, Pin_10, Pin_11, Pin_12)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        ElseIf (Pin13.BackColor <> Color.Black And Pin14.BackColor <> Color.Black And Pin15.BackColor <> Color.Black And Pin16.BackColor <> Color.Black) Then
            bclick(rounds, Button4, GroupBox4, GroupBox5, Pin13, Pin14, Pin15, Pin16, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_13, Pin_14, Pin_15, Pin_16)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        ElseIf (Pin17.BackColor <> Color.Black And Pin18.BackColor <> Color.Black And Pin19.BackColor <> Color.Black And Pin20.BackColor <> Color.Black) Then
            bclick(rounds, Button5, GroupBox5, GroupBox6, Pin17, Pin18, Pin19, Pin20, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_17, Pin_18, Pin_19, Pin_20)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        ElseIf (Pin21.BackColor <> Color.Black And Pin22.BackColor <> Color.Black And Pin23.BackColor <> Color.Black And Pin24.BackColor <> Color.Black) Then
            bclick(rounds, Button6, GroupBox6, GroupBox7, Pin21, Pin22, Pin23, Pin24, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_21, Pin_22, Pin_23, Pin_24)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        ElseIf (Pin25.BackColor <> Color.Black And Pin26.BackColor <> Color.Black And Pin27.BackColor <> Color.Black And Pin28.BackColor <> Color.Black) Then
            bclick(rounds, Button7, GroupBox7, GroupBox8, Pin25, Pin26, Pin27, Pin28, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_25, Pin_26, Pin_27, Pin_28)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        ElseIf (Pin29.BackColor <> Color.Black And Pin30.BackColor <> Color.Black And Pin31.BackColor <> Color.Black And Pin32.BackColor <> Color.Black) Then
            bclick(rounds, Button8, GroupBox8, GroupBox9, Pin29, Pin30, Pin31, Pin32, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_29, Pin_30, Pin_31, Pin_32)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        ElseIf (Pin33.BackColor <> Color.Black And Pin34.BackColor <> Color.Black And Pin35.BackColor <> Color.Black And Pin36.BackColor <> Color.Black) Then
            bclick(rounds, Button9, GroupBox9, GroupBox10, Pin33, Pin34, Pin35, Pin36, Pin_res1, Pin_res2, Pin_res3, Pin_res4, Pin_33, Pin_34, Pin_35, Pin_36)
        Else
            MsgBox(" Put All 4 Guesses First !")
        End If
    End Sub
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        f1.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedDialog
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If mlsec = 100 Then
            ...
            If sec = 60 Then
                ...
                If min = 60 Then
                    Timer1.Stop()
                    time = Convert.ToString(min & ":" & sec & ":" & mlsec)
                    Label1.Text = min & ":" & sec & ":" & mlsec
                End If
            End If
        End If
