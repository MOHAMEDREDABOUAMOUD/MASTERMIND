...
Public Class level_2
    ...
    Private Sub bclick(but2 As Button, grp1 As GroupBox, grp2 As GroupBox, pinn1 As PIN, pinn2 As PIN, pinn3 As PIN, pinn4 As PIN, pinn_res1 As PIN, pinn_res2 As PIN, pinn_res3 As PIN, pinn_res4 As PIN, pinn_1 As PIN, pinn_2 As PIN, pinn_3 As PIN, pinn_4 As PIN)
        ...
        If pinn_1.BackColor = Color.Blue And pinn_2.BackColor = Color.Blue And pinn_3.BackColor = Color.Blue And pinn_4.BackColor = Color.Blue Then
            ...
            f_win2.Label2.Text = "  Time : " & min & ":" & sec & ":" & mlsec
            f_win2.Label3.Text = "  Rounds : " & rounds
            f_win2.ShowDialog()
    ...
    Private Sub level_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        f2.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedDialog
    ...
    Private Sub Pinchoice9_MouseDown(sender As Object, e As MouseEventArgs) Handles Pinchoice9.MouseDown
        cnt = 9
        Pinchoice8.DoDragDrop(Pinchoice9, DragDropEffects.Copy)
    End Sub

    Private Sub Pinchoice10_MouseDown(sender As Object, e As MouseEventArgs) Handles Pinchoice10.MouseDown
        cnt = 10
        Pinchoice8.DoDragDrop(Pinchoice10, DragDropEffects.Copy)
    End Sub
    '-------------------------------------------------------------------
